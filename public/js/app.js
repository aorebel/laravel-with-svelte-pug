...
function add_css() {
	...
	style.id = "svelte-1at2pip-style";
	style.textContent = "h1.svelte-1at2pip{size:24px !important;color:cornflowerblue;text-align:center;font-family:century gothic}";
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			h1.textContent = "Welcome to Laravel with Svelte and PUG";
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(h1, "class", "svelte-1at2pip");
		},
		m(target, anchor) {
...
class App extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponent"] {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-1at2pip-style")) add_css();
...
__webpack_require__(/*! G:\_laragon\www\withsveltepug\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! G:\_laragon\www\withsveltepug\resources\sass\app.scss */"./resources/sass/app.scss");
